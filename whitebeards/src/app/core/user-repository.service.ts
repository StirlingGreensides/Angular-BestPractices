...
export class UserRepositoryService {
  ...
  saveUser(user): Observable<any> {
    this.currentUser = Object.assign({}, this.currentUser, { classes: user.class || [] });
  ...
  enroll(classId): Observable<any> {
    ...
    this.currentUser = Object.assign({}, this.currentUser, { classes: this.currentUser.classes.push(classId) });
